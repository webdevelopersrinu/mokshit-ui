...
import navbarSnippets from '../snippets/navbars';
            ...
            <div className="max-w-4xl mx-auto">
                ...
                <div className="mb-8">
                    ...
                    <p className="text-lg text-gray-600 dark:text-gray-400">
                        A collection of ready-to-use navigation components built with Tailwind CSS.
                ...
                <div className="mt-16 p-6 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-100 dark:border-blue-800">
                    ...
                    <ul className="space-y-3 text-gray-700 dark:text-gray-300">
                        <li className="flex items-start">
                            ...
                            <p>
                                <strong>Consistency:</strong> Keep navigation elements consistent across your pages to ensure a smooth user experience.
                            </p>
                        </li>
                        <li className="flex items-start">
                            <svg
                            ...
                            <p>
                                <strong>Accessibility:</strong> Ensure that navigation components are accessible by using proper ARIA roles and enabling keyboard navigation.
                            </p>
                        </li>
                        <li className="flex items-start">
                            <svg
                            ...
                            <p>
                                <strong>Responsiveness:</strong> Design navigation that works seamlessly on all devices, including a mobile menu for smaller screens.
                            </p>
                        </li>
                    </ul>
                </div>
